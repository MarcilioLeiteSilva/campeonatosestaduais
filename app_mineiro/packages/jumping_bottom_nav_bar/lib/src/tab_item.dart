...
class TabItemState extends State<TabItem> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    transAnim = Tween(
      ...
      begin: widget.tabItemIcon == null
          ? Colors.black
          : widget.tabItemIcon!.startColor,
      end: widget.tabItemIcon == null
          ? Colors.white
          : widget.tabItemIcon!.endColor,
    ).animate(animationController);
        ...
        child: AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            child: Transform.translate(
              ...
              child: widget.tabItemIcon !=null && widget.tabItemIcon!.buildWidget != null
