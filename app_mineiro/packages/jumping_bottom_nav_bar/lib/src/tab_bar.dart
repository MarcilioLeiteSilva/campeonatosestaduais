...
class _JumpingTabBarState extends State<JumpingTabBar>
  ...
  void didChangeDependencies() {
    ...
    //  final TabController _newController = DefaultTabController.of(context);
  ...
  void onTabCtrlChange() {
    if ((tabController?.index ?? 0) + 1 != selectedIndex)
      onChangeTab((tabController?.index ?? 0) + 1, shouldCallParent: false);
  }
