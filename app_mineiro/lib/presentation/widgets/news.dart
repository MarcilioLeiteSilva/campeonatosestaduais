...
class CardNewsItemReal extends StatelessWidget {
  const CardNewsItemReal({super.key, required this.news});
        ...
        child: Row(
          children: [
            SizedBox(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(10),
                child: news.image.startsWith('http')
...
class CardNewsCarouselItemReal extends StatelessWidget {
  const CardNewsCarouselItemReal({super.key, required this.news});
  final NewsModel news;
