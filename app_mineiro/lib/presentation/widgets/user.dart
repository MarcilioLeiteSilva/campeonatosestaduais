...
class CardFollowItem extends StatelessWidget {
  const CardFollowItem({super.key, this.onNotif, this.onTap});
...
class CardFollowItemReal extends StatelessWidget {
  const CardFollowItemReal({super.key, required this.team, this.onTap});
