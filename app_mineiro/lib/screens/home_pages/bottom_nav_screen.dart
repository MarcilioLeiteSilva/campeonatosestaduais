import 'package:app_mineiro/screens/home_pages/news.dart';
                ...
                child: JumpingTabBar(
                  ...
                  items: [
                    TabItemIcon(
                      ...
                      endColor: theme.colorScheme.surface,
                      curveColor: theme.colorScheme.surface,
                    ),
                    TabItemIcon(
                      buildWidget: (_, color) => TabBottomMain(
...
class TabBottomMain extends StatelessWidget {
  ...
  TabBottomMain({this.isSelected = false, required this.icon});
